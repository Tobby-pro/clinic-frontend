...
export default function PatientLoginPage() {
  ...
  const [password, setPassword] = useState(""); // This is the 6-digit PIN
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response) {
        ...
        // Wait a beat for the cookie to settle
        setTimeout(() => {
  ...
  return (
    <section className={`relative min-h-screen flex items-center justify-center bg-[#fafafa] px-4 overflow-hidden ${poppins.className}`}>
      {/* Visual background sync with Register page */}
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-xs text-slate-400 mt-2">
            Enter your patient credentials to continue.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                type="email"
                placeholder="e.g. tobby@example.com"
                value={email}
