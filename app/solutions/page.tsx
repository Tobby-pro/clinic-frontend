...
/*
  ✅ FIX ADDED:
  Imported reusable global back button wrapper
*/
...
const solutionCards = [
  {
    ...
    description:
      "Centralize your clinic's master ledger and appointment registry in one secure hub.",
  ...
  },
  {
    ...
    description:
      "Focus on care while we handle automated patient alerting and document verification.",
  ...
  },
  {
    ...
    description:
      "Provide a seamless experience from booking to billing with automated compliance checks.",
...
export default function SolutionsPage() {
  return (
    ...
    /*
      ✅ FIX ADDED:
      Wrapped page with AuthLayoutWrapper
      so back button now appears globally
    */
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-24">
            ...
            <div className="max-w-xl">
              ...
              >
                <Link
                  href="/admin/register"
                  className="bg-[#ff7600] text-white px-8 py-4 rounded-2xl font-bold text-sm shadow-lg shadow-orange-200 hover:bg-[#e56b00] transition-all"
                >
                  Start Building
                </Link>
                ...
                <Link
                  href="/demo"
                  className="text-slate-900 font-bold text-sm hover:text-[#ff7600] transition-colors"
                >
                  View Demo
                </Link>
              </motion.div>
            ...
            {solutionCards.map((card, idx) => (
              ...
              >
                ...
                <div className="flex items-center justify-between pt-6 border-t border-slate-50">
                  ...
                  <span className="text-[10px] font-bold text-[#ff7600] uppercase tracking-wider">
                    {card.stats}
                  </span>
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10">
                    ...
                    <p className="text-sm font-medium">
                      256-bit AES Encryption for all clinic records
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10">
                    ...
                    <p className="text-sm font-medium">
                      Automated Registry Sync with Local Master Ledgers
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10">
                    ...
                    <p className="text-sm font-medium">
                      Real-time Compliance Monitoring Bot
                    </p>
                  </div>
              ...
              <div className="text-center md:text-right">
                ...
                <p className="text-slate-400 font-medium mb-8">
                  Ready to transform your clinic workflow?
                </p>
